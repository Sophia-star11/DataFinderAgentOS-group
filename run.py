...
from app.controllers.home import (IndexHandler, GestureHandler, AdminIndexHandler, DashboardStatsApiHandler,
    ...
    DataScreenTrendsApiHandler, DataScreenSourceApiHandler, DataScreenSankeyApiHandler, DataScreenGlobeApiHandler, DataScreenStatusApiHandler,
    ...
    OpinionScanApiHandler, OpinionBatchReviewApiHandler, OpinionBatchDeleteApiHandler, SensitiveWordsApiHandler, SensitiveWordsCreateApiHandler,
...
cookie_secret=config.COOKIE_SECRET,
    ...
    return tornado.web.Application([
        ...
        (r"/api/data-screen/globe", DataScreenGlobeApiHandler),
        (r"/api/data-screen/status", DataScreenStatusApiHandler),
        ...
        (r"/api/opinion/batch-delete", OpinionBatchDeleteApiHandler),
